		...
		<form id="fregistro-asociado" class="col-12">
			...
			<legend class="texto-rojo">Registrar Asociado</legend>
				...
				<div class="form-group col-lg-12">
					...
					<select requiered id="colegio_id" name="colegio_id" data-nombre="Colegios" class="custom-select" data-objetivo="#fregistro-asociado #colegio">
				...
				<div class="form-group col-lg-4">
					...
					<input required type="text" class="form-control mayusculas" id="nombre" name="nombre" data-nombre="Nombre">
				</div>
				<div class="form-group col-lg-4">
					<label for="primer_apellido">Primer apellido</label>
					<input required type="text"  class="form-control mayusculas" id="primer_apellido" name="primer_apellido" data-nombre="Primer apellido">
				</div>
				<div class="form-group col-lg-4">
					<label for="segundo_apellido">Segundo apellido </label>
					<input required type="text"  class="form-control mayusculas" id="segundo_apellido" name="segundo_apellido" data-nombre="Segundo apellido">
				</div>
				<div class="form-group col-lg-4">
				...
				<div class="form-group col-lg-4">
					...
					<input required type="text"  class="form-control valdar-curp mayusculas" id="curp" name="curp" data-nombre="CURP">
				</div>
				<div class="form-group col-lg-4">
